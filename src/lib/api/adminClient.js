...
export const tokoApi = {
  ...
  search: (query) => call('tokoApi.search', null, query),
  // UPDATED: Support targetPlan parameter
  confirmUpgrade: (token, userId, targetPlan = 'pro') => call('tokoApi.confirmUpgrade', token, userId, targetPlan),
}
...
export const pesananApi = {
  ...
  // NEW: Get by Order ID (Public Access - untuk InvoicePage)
  getByOrderId: (orderId) => call('pesananApi.getByOrderId', null, orderId),
...
export const adminApi = {
  ...
  // NEW: General grant plan (starter/pro/business)
  grantPlan: (token, targetUserId, planName, months) => call('adminApi.grantPlan', token, targetUserId, planName, months),
  
  // ALIAS: Backward compatibility (tetap bisa dipakai)
...
// ================================================
// PAYMENT (DANA MOCK MODE)
// ================================================
export const paymentApi = {
  createUpgradePayment: (data) => call('paymentApi.createUpgradePayment', null, data),
  checkPaymentStatus: (paymentId) => call('paymentApi.checkPaymentStatus', null, paymentId),
  getMyPayments: () => call('paymentApi.getMyPayments', null),
}
