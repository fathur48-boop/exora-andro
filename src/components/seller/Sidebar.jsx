...
import {
  ...
  Store, BarChart2, Sun, Moon, Rss, Lock, Crown
} from 'lucide-react'
import { useAuthStore, useTokoStore } from '../../lib/store.js'
import { pesananApi } from '../../lib/api/index.js'
import { getInitials, isPro, isStarter, isBusiness, getTierLevel, getPlanDisplayName } from '../../lib/utils.js'
...
export default function Sidebar() {
  ...
  const NAV_ITEMS = [
    ...
    { to: '/dashboard/stream', label: 'Stream', icon: Rss, locked: tierLevel < 1 }, // minimal STARTER
    { to: '/dashboard/analytics', label: 'Analitik', icon: BarChart2, locked: tierLevel < 1 }, // minimal STARTER
        ...
        {business && (
          <div
            style={{
              ...
              padding: '10px 12px', borderRadius: 'var(--radius-md)',
              fontFamily: PJS, fontSize: '0.8rem', fontWeight: 600,
              color: '#10B981',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 12px', marginBottom: '4px' }}>
          ...
          <div style={{ flex: 1, overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', flexWrap: 'wrap' }}>
              <span className={'badge ' + (pro ? 'badge-pro' : business ? 'badge-business' : starter ? 'badge-starter' : 'badge-free')} style={{ fontSize: '0.65rem', padding: '1px 6px' }}>
